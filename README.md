...
A thermastat that meets the requirements of a customer listed below.
...
## How to use
Open index.html or visit the preview [here](http://htmlpreview.github.io/?https://github.com/Achlaw/thermostat_js/blob/master/index.html).
